...
int index_hs =0;
int index_tf =0;
unsigned long HS_time[20];
unsigned long MS_time[20];
unsigned long TF_time[20];
...
BLECharacteristic HS_MS_TFCharacteristic( "3109", BLEWrite | BLERead | BLENotify, 512 ); // on the peripheral side
...
// ---------------------------------------- CONSTANTS ---------------------------------------------
int INITIAL_TIME_BETWEEN_STATES = 160;            // initial minimum time required between states
int INITIAL_AMPLITUDE = 0;                        // initial minimum angular velocity required
int STEP_MAX_TIME = 3000;                         // if we pass this threshhold we find a step from start again
int RESTART_THRESH = 20000;                       // after this threshhold we restart dynamic variables
float TIME_FLEX = 0.8;                            // defines a minimum time before allowing a state change. The smaller the flexabiliy, the closer timing needs to be compared to the dynamic average
float VALUE_FLEX = 0.7;                           // defines a range of velocity to allow a state change. The smaller the flexabiliy, the closer the velocity needs to be compared to the dynamic average
float AVG_CHANGE_RATE = 0.2;                      // defines the weight of the current step in updating the dynamic average
float VALID_STEP_RATIO = 0.4;                     // defines a range of times that represent valid timings for MS/TO/HS compared to previous step, to avoid adding sudden changes to the dynamic average
float CORRELATION_RATIO = 0.7;                    // defines the correlation of velocities between the HS and TO, to improve the HS detection
float STATE_SWITCH_THRESH = 0.5;                  // if we get stuck searhing for TO, this thresh defines when to restart state and search for MS

// --------------------------------------- THRESHOLDS -------------------------------------------

int step_state = 3;                               // MS=1, HS=2, TF=3

int HStoTF = INITIAL_TIME_BETWEEN_STATES;         // the minimum time required between heel strike to toe off
int MStoHS = INITIAL_TIME_BETWEEN_STATES;         // the minimum time required between mid swing to heel strike
int TFtoMS = INITIAL_TIME_BETWEEN_STATES;         // the minimum time required between toe off to mid swing

int prev_HS = INITIAL_AMPLITUDE;                  // initial velocity values for previous steps
int prev_MS = INITIAL_AMPLITUDE;                  // initial velocity values for previous steps

int prev_state_time = 0;                          // initial timing values
int prev_step_time = 0;                           // initial timing values

int step_thresh = STEP_MAX_TIME;                  // time to restart after not finding an MS state
int restart_time = 0;                             // timer from beginning and updates every MS
...
int sum_avg_vel = 0;
int sum_time = 0;
int cou = 0; //counting 4 samples, and averaging them to give a more accurate measurment
...
void setup() {
  ...
  BLE.setDeviceName("Gait Analysis system");      // this sets Characteristic 0x2a00 of Service 0x1800
  ...
  BLE.setLocalName("MYGAIT");       // this sets the local name for the advertising data
  ...
  gaitDetectionService.addCharacteristic(HS_MS_TFCharacteristic);
...
void loop()
{
  ...
  if (!conn) {//no one connected yet
    ...
    if (test_mode and (currentMillis >= TEST_MODE_TIME + startMillis)) {
      ...
      m5600Data.values.angVelY1 = HS_vals[0], m5600Data.values.time1 = HS_time[0];
      m5600Data.values.angVelY2 = HS_vals[1], m5600Data.values.time2 = HS_time[1];
      m5600Data.values.angVelY3 = HS_vals[2], m5600Data.values.time3 = HS_time[2];
      m5600Data.values.angVelY4 = HS_vals[3], m5600Data.values.time4 = HS_time[3];
      m5600Data.values.angVelY5 = HS_vals[4], m5600Data.values.time5 = HS_time[4];
      m5600Data.values.angVelY6 = HS_vals[5], m5600Data.values.time6 = HS_time[5];
      m5600Data.values.angVelY7 = HS_vals[6], m5600Data.values.time7 = HS_time[6];
      m5600Data.values.angVelY8 = HS_vals[7], m5600Data.values.time8 = HS_time[7];
      m5600Data.values.angVelY9 = HS_vals[8], m5600Data.values.time9 = HS_time[8];
      m5600Data.values.angVelY10 = HS_vals[9], m5600Data.values.time10 = HS_time[9];
      m5600Data.values.angVelY11 = HS_vals[10], m5600Data.values.time11 = HS_time[10];
      m5600Data.values.angVelY12 = HS_vals[11], m5600Data.values.time12 = HS_time[11];
      m5600Data.values.angVelY13 = HS_vals[12], m5600Data.values.time13 = HS_time[12];
      m5600Data.values.angVelY14 = HS_vals[13], m5600Data.values.time14 = HS_time[13];
      m5600Data.values.angVelY15 = HS_vals[14], m5600Data.values.time15 = HS_time[14];
      m5600Data.values.angVelY16 = HS_vals[15], m5600Data.values.time16 = HS_time[15];
      m5600Data.values.angVelY17 = HS_vals[16], m5600Data.values.time17 = HS_time[16];
      m5600Data.values.angVelY18 = HS_vals[17], m5600Data.values.time18 = HS_time[17];
      m5600Data.values.angVelY19 = HS_vals[18], m5600Data.values.time19 = HS_time[18];
      m5600Data.values.angVelY20 = HS_vals[19], m5600Data.values.time20 = HS_time[19];

      m5600Data.values.angVelY21 = MS_vals[0], m5600Data.values.time21 = MS_time[0];
      m5600Data.values.angVelY22 = MS_vals[1], m5600Data.values.time22 = MS_time[1];
      m5600Data.values.angVelY23 = MS_vals[2], m5600Data.values.time23 = MS_time[2];
      m5600Data.values.angVelY24 = MS_vals[3], m5600Data.values.time24 = MS_time[3];
      m5600Data.values.angVelY25 = MS_vals[4], m5600Data.values.time25 = MS_time[4];
      m5600Data.values.angVelY26 = MS_vals[5], m5600Data.values.time26 = MS_time[5];
      m5600Data.values.angVelY27 = MS_vals[6], m5600Data.values.time27 = MS_time[6];
      m5600Data.values.angVelY28 = MS_vals[7], m5600Data.values.time28 = MS_time[7];
      m5600Data.values.angVelY29 = MS_vals[8], m5600Data.values.time29 = MS_time[8];
      m5600Data.values.angVelY30 = MS_vals[9], m5600Data.values.time30 = MS_time[9];
      m5600Data.values.angVelY31 = MS_vals[10], m5600Data.values.time31 = MS_time[10];
      m5600Data.values.angVelY32 = MS_vals[11], m5600Data.values.time32 = MS_time[11];
      m5600Data.values.angVelY33 = MS_vals[12], m5600Data.values.time33 = MS_time[12];
      m5600Data.values.angVelY34 = MS_vals[13], m5600Data.values.time34 = MS_time[13];
      m5600Data.values.angVelY35 = MS_vals[14], m5600Data.values.time35 = MS_time[14];
      m5600Data.values.angVelY36 = MS_vals[15], m5600Data.values.time36 = MS_time[15];
      m5600Data.values.angVelY37 = MS_vals[16], m5600Data.values.time37 = MS_time[16];
      m5600Data.values.angVelY38 = MS_vals[17], m5600Data.values.time38 = MS_time[17];
      m5600Data.values.angVelY39 = MS_vals[18], m5600Data.values.time39 = MS_time[18];
      m5600Data.values.angVelY40 = MS_vals[19], m5600Data.values.time40 = MS_time[19];

      m5600Data.values.angVelY41 = TF_vals[0], m5600Data.values.time41 = TF_time[0];
      m5600Data.values.angVelY42 = TF_vals[1], m5600Data.values.time42 = TF_time[1];
      m5600Data.values.angVelY43 = TF_vals[2], m5600Data.values.time43 = TF_time[2];
      m5600Data.values.angVelY44 = TF_vals[3], m5600Data.values.time44 = TF_time[3];
      m5600Data.values.angVelY45 = TF_vals[4], m5600Data.values.time45 = TF_time[4];
      m5600Data.values.angVelY46 = TF_vals[5], m5600Data.values.time46 = TF_time[5];
      m5600Data.values.angVelY47 = TF_vals[6], m5600Data.values.time47 = TF_time[6];
      m5600Data.values.angVelY48 = TF_vals[7], m5600Data.values.time48 = TF_time[7];
      ...
      m5600Data.values.angVelY64 = 0, m5600Data.values.time64 = 0;
      HS_MS_TFCharacteristic.writeValue(m5600Data.bytes, 512);
    }
    if (cou == 4) {
      if (index_arr < 2048) {
        val_arr[index_arr] = sum_avg_vel / 4.0;
        time_arr [index_arr] = sum_time / 4.0;
        index_arr++;
      }
      ...
      if (min_samples >= 5) { //array is full
        ...
        //---------------------------------HS-----------------------------------------------
          ...
          analogWrite(LED_BUILTIN, 155 + vib_power*33); //(255/3 = 85)
          step_state = 2;
